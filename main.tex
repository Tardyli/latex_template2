...
\newcommand{\thesissignatureimage}[2]{%
    \raisebox{-0.38\height}{\includegraphics[height=#1]{#2}}%
}
\newcommand{\thesisdeclsignedline}[2]{%
    \par\vspace{8pt}
    {\thesisdeclbodyfont\noindent
    \hspace*{2em}#1\hspace{0.6em}#2\hfill
    {\tnr 2026}年{\tnr 5}月{\tnr 28}日\par}
    \vspace{8pt}
}
...
\newcommand{\customtableofcontents}{
    ...
    \renewcommand{\numberline}[1]{{\let\hspace\@gobble ##1}\space}
    \vspace*{-30pt}
