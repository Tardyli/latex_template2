...
\thesisdeclsignedline{论文作者签名：}{\thesissignatureimage{1.15cm}{figures/signature_author.png}}
\thesisdeclsignedline{指导教师签名：}{\thesissignatureimage{0.72cm}{figures/signature_advisor.png}}
